...
- `post.html` — один пост + комментарии.
- `archive-post.html` — архивированный пост.
- `create-post.html` — форма создания поста.
- `error.html` — отображение ошибок.

---

### 👤 Сессии и идентификация

- Хранение в cookies (1 неделя).
- Присвоение аватара + имени через Rick & Morty API.
- Уникальность аватара в пределах поста.
- Повторное использование аватаров при нехватке.
...
- **S3 или MinIO** — хранение изображений (минимум 2 бакета).
...
- Уровни логирования:
  ...
  - `Warning`
  - `Error`
- Обязательный контекст: время, ID и т.д.
